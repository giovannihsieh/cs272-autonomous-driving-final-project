...
LOG_DIR = "./highway_lidar_id1_2_logs/"
TENSORBOARD_DIR = "./highway_lidar_id1_2_tb/"
MODEL_NAME = "highway_lidar_id1_2_model"
NUM_ENVS = 8
TRAIN_STEPS = 500_000
EVAL_EPISODES = 500
RUN_TUNING = False
TUNING_CSV_PATH = "highway_lidar_id1_2_tuning_results.csv"
LEARNING_CURVE_PATH = "highway_lidar_id1_learning_curve_tuned.png"
LEARNING_CURVE_TITLE = "Learning Curve - PPO - Highway Env (LidarObservation)"
PERFORMANCE_VIOLIN_PATH = "highway_lidar_id2_performance_test_tuned.png"
PERFORMANCE_VIOLIN_TITLE = (
    "Performance 500 Episodes - PPO - Highway Env (LidarObservation)"
)
