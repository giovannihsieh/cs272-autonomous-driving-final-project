...
def make_env(rank: int):
    def _init():
        ...
        env = Monitor(
            env,
            filename=f"./merge_lidar_logs/monitor_{rank}.csv",
...
if __name__ == "__main__":
    ...
    print("Training PPO 500k steps Merge‑v0 Lidar.")
    ...
    plt.title("Learning Curve - PPO - Merge Env (LidarObservation)")
    plt.xlabel("Episode")
    plt.ylabel("Reward")
    plt.savefig("ID_5_merge_lidar_learning_curve_tuned.png")
    plt.show()
    ...
    plt.title("Performance 500 episodes - PPO - Merge Env (LidarObservation)")
    plt.ylabel("Return")
    plt.tight_layout()
    plt.savefig("ID_6_merge_lidar_performance_test_tuned.png")
    plt.show()
