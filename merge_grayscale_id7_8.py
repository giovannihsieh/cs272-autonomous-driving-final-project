...
LOG_DIR = "./merge_grayscale_id7_8_logs/"
TENSORBOARD_DIR = "./merge_grayscale_id7_8_tb/"
MODEL_NAME = "merge_grayscale_id7_8_model"
NUM_ENVS = 8
TRAIN_STEPS = 500_000
EVAL_EPISODES = 500
RUN_TUNING = False
TUNING_CSV_PATH = "merge_grayscale_id7_8_tuning_results.csv"
LEARNING_CURVE_PATH = "merge_grayscale_id7_learning_curve_tuned.png"
LEARNING_CURVE_TITLE = "Learning Curve - PPO - Merge Env (GrayscaleObservation)"
PERFORMANCE_VIOLIN_PATH = "merge_grayscale_id8_performance_test_tuned.png"
PERFORMANCE_VIOLIN_TITLE = (
    "Performance 500 Episodes - PPO - Merge Env (GrayscaleObservation)"
)
